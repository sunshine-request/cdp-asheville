...
fireo.connection(client=Client(
    project="cdp-asheville-ektqmrjs",
...
fs = GCSFileSystem(project="cdp-asheville-ektqmrjs", token="anon")
...
in the
[admin-docs directory](https://github.com/sunshine-request/cdp-asheville/tree/main/admin-docs).
